...
export default {
  ...
  computed: {
    classesBack() {
      return this.name === 'science and nature' 
        ? 'bg-emerald-300' 
        : this.name === 'history'
          ? 'bg-yellow-300'
          : this.name === 'sports'
